...
function scr_globales_leo(){
	...
	global.list_resources[1][3][0] = obj_respawn_fantasma_normal;
	global.list_resources[1][3][1] = obj_respawn_fantasma_tanque;
	
	global.list_resources[2][3][0] = obj_respawn_fantasmas_creator;
	
	global.list_resources[3][3][0] = obj_respawn_fantasma_tanque;
	
	//columna 4 de todas las categorias
	for(var _index = 0; _index < 4; _index ++){
		global.list_resources[_index][4][0] = obj_controller_joystick;
		global.list_resources[_index][4][1] = obj_controller_keyboards;
		global.list_resources[_index][4][2] = obj_controller_click;
		global.list_resources[_index][4][3] = obj_controller_drag;
		
		
		global.list_resources[_index][5][0] = obj_respawn_button_circle;
		global.list_resources[_index][5][1] = obj_respawn_button_circle_largo;
		global.list_resources[_index][5][2] = obj_respawn_button_cuadrado;
		global.list_resources[_index][5][3] = obj_respawn_button_cuadrado_largo;
		
		global.list_resources[_index][6][0] = obj_respawn_teletransporte_puerta;
		global.list_resources[_index][6][1] = obj_respawn_teletransporte_piso;
		global.list_resources[_index][6][2] = obj_respawn_puerta;
