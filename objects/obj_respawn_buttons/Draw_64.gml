...
if(selection){
	...
	draw_roundrect(position_x - width / 2, position_y - 48, position_x + width / 2, position_y + 48, 0);
}
draw_set_alpha(1);
...
draw_line_width_color(position_x - width /2 + 5, position_y - 48, position_x - width / 2 + 5, position_y + 48, 5, c_black, c_dkgray);
