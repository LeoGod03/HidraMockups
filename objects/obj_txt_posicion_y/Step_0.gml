...
if (string_length(texto) && !activo) {
    ...
    if (_valor >= 0 && _valor <= obj_interfaz_controller.lenght_level_height) {
       
    }else{
		show_message("El rango permitido es de 0 a " + string(obj_interfaz_controller.lenght_level_height));
